    ...
    if (coords) {
      ...
      const popupContent = `
        <div style="padding: 10px; min-width: 200px;">
          ...
          <p style="margin: 0 0 5px 0; color: ${getMarkerColor(food.urgency)}; font-size: 14px; font-weight: bold;">
          ...
          {coordinates && (
            <div style={{
              ...
              <p style={{ margin: 0, color: '#666', fontSize: '14px' }}>
                <i className="fa fa-map-marker" style={{ color: coordinates.isApproximate ? '#ffc107' : getUrgencyColor(food.urgency), marginRight: '5px' }}></i>
                {food.location}
